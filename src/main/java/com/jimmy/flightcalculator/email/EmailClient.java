...
public class EmailClient {
	...
	public void sendEmail(String to, final String from, final String password, String subject, String bodyText)
	...
	private void transportEmail(Session session, String to, String from, String password, String subject,
